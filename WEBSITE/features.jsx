  ...
  return (
    <section className="features-wrap" id="features" data-screen-label="04 Features">
      ...
      <div className="features-grid">
        ...
        {/* Bento Card 6: Active Track & Monitor FX */}
        <div className="feat-card span-6 dark">
          <div className="library-layout">
            <div className="library-text">
              <h3>Track & Monitor FX Management.</h3>
              <p>Inspect real-time plugins loaded on your selected REAPER track. Easily reorder, bypass, or float FX windows, and manage dedicated master monitoring plugins (room correction, meters, headphone compensation) in a clean separate tab.</p>
            </div>
          </div>
        </div>
...
const ThumbnailBrowserVisual = () => {
  ...
  const thumbs = [
    'imgs/fabfilter_pro-q_3_vst3.png',
    'imgs/arturia_analog_lab_v_vst3i.png',
    'imgs/klevgrand_korvpressor_vst3.png',
    'imgs/native_instruments_kontakt_8_vst3i.png',
    'imgs/native_instruments_massive_vst3i.png',
    'imgs/blue_cat_audio_blue_cat_s_patchwork_vst3.png',
    'imgs/musik_hack_master_plan_v1_5_vst3.png',
    'imgs/cockos_reacomp_vst.png'
  ];
    ...
    <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, flex: 1 }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
              <img src="imgs/fabfilter_pro-q_3_vst3.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          ...
          <div style={{
            ...
            {isDropped ? (
              <>
                <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
                  <img src="imgs/blue_cat_audio_blue_cat_s_patchwork_vst3.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
                <div style={{ padding: '3px 5px', display: 'flex', flexDirection: 'column', background: 'rgba(7, 9, 14, 0.9)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
              <img src="imgs/klevgrand_korvpressor_vst3.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div style={{ padding: '3px 5px', display: 'flex', flexDirection: 'column', background: 'rgba(7, 9, 14, 0.9)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
          <div style={{
            ...
            <img src="imgs/blue_cat_audio_blue_cat_s_patchwork_vst3.png" alt="" style={{ width: 16, height: 12, objectFit: 'cover', borderRadius: 2 }} />
          ...
          <div style={{
            ...
            <img src="imgs/native_instruments_massive_vst3i.png" alt="" style={{ width: 16, height: 12, objectFit: 'cover', borderRadius: 2 }} />
          ...
          <div style={{
            ...
            <img src="imgs/musik_hack_master_plan_v1_5_vst3.png" alt="" style={{ width: 16, height: 12, objectFit: 'cover', borderRadius: 2 }} />
      ...
      {isDragging && (
        <div style={{
          ...
          <img src="imgs/blue_cat_audio_blue_cat_s_patchwork_vst3.png" alt="" style={{ width: 24, height: 18, objectFit: 'cover', borderRadius: 2 }} />
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src="imgs/native_instruments_massive_vst3i.png" alt="" style={{ width: '100%', height: '35px', objectFit: 'cover' }} />
        ...
        <div style={{
          ...
          <img src="imgs/native_instruments_kontakt_8_vst3i.png" alt="" style={{ width: 16, height: 12, objectFit: 'cover', borderRadius: 2 }} />
      ...
      {isDragging && (
        <div style={{
          ...
          <img src="imgs/native_instruments_massive_vst3i.png" alt="" style={{ width: 24, height: 18, objectFit: 'cover', borderRadius: 2 }} />
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1, overflow: 'hidden' }}>
...
const SearchFilterVisual = () => {
  ...
  const plugins = [
    { name: 'Master Compressor', format: 'VST3', type: 'Dynamics', dev: 'Core Dynamics', image: 'imgs/klevgrand_korvpressor_vst3.png' },
    { name: 'Vintage Reverb', format: 'AU', type: 'Reverb', dev: 'Classic Reverbs', image: 'imgs/valhalla_dsp_valhallavintageverb_vst3.png' },
    { name: 'Multi-FX Rack', format: 'VST3', type: 'Multi-FX', dev: 'FX DSP Lab', image: 'imgs/native_instruments_guitar_rig_7_fx_aui.png' },
    { name: 'Space Reverb', format: 'VST3', type: 'Reverb', dev: 'Ambient Space', image: 'imgs/fabfilter_pro-r_2_vst3.png' }
  ];
