  ...
  return (
    <header className="site-header">
      ...
      <div className="site-header-actions">
        ...
        <a href="#" className="header-btn header-btn-primary active">Buy (Coming soon)</a>
      </div>
    </header>
  );
};
          ...
          <div className="product-layout-grid" style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: '48px', alignItems: 'start' }}>
            ...
            <div className="product-details-panel">
              ...
              <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid var(--line)' }}>
                ...
                <ul style={{ paddingLeft: '1.25rem', display: 'grid', gap: '8px', fontSize: '13px', color: 'var(--t-2)', lineHeight: '1.5', margin: 0 }}>
                  <li>REAPER 6.0 or newer is required.</li>
                  <li>Recommended and tested on macOS Tahoe and Windows 11.</li>
                  <li>It might work on earlier systems, but I recommend testing it before buying with the 10-day trial version.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="pricing-sidebar" style={{ display: 'grid', gap: '24px' }}>
              ...
              <article className="feature-card" style={{ padding: '32px', borderRadius: '16px', background: 'var(--bg-2)', border: '1px solid var(--line)' }}>
                ...
                <a href="#" className="btn-ghost" style={{ display: 'block', textAlign: 'center', width: '100%', padding: '12px' }}>Coming soon</a>
              </article>
