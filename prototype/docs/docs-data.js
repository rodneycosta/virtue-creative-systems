...
const docData = {
      ...
      sections: [
        {
          ...
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>

              <div class="os-tab-container">
                <div class="os-tabs">
                  <button class="os-tab-btn active" data-os="mac">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3.18 3.18 0 0 1 2 2c0 .7-.22 1.33-.62 1.81A3 3 0 0 1 12 8a3 3 0 0 1-2-2.19C9.64 5.3 9.38 4.7 9.38 4a3.18 3.18 0 0 1 2.62-2zM12 8c-2.4 0-3 1.8-3 3.6 0 3.2 2.5 7.4 5.4 7.4s2.4-1.2 3.6-1.2 1.2 1.2 3.6 1.2c2.4 0 5.4-4.2 5.4-7.4s-.6-3.6-3-3.6c-1.2 0-2.4.6-3 .6s-1.8-.6-3-.6z"></path></svg>
                    macOS Installation
                  </button>
                ...
                <div class="os-tab-content active" data-os="mac">
                  ...
                  <p style="margin-bottom: 1.5rem; font-size: 0.95rem; line-height: 1.6;">
                    Virtue FX Manager for macOS is distributed as a signed and notarized installer package (<code>.pkg</code>) wrapped inside a disk image (<code>.dmg</code>). Follow these steps to complete the installation:
                  </p>
                  ...
                  <div style="display: flex; flex-direction: column; gap: 2rem; margin-top: 1rem;">
                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      ...
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">Double-click the downloaded <code>VirtueFXManager.dmg</code> disk image. Inside the volume window, you will see the installer <strong>"VirtueFXManager.pkg"</strong> and the <strong>"Uninstall Virtue"</strong> app.</p>
                      <figure style="margin: 0; max-width: 800px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_01.png" alt="macOS DMG - Open DMG contents" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 2: Run the Installer Package</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);"><strong>CRITICAL: Close REAPER completely before running the installer.</strong> Then double-click the <code>VirtueFXManager.pkg</code> icon to run the installer wizard. Click <strong>"Continue"</strong> on the Welcome screen.</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_02.png" alt="macOS Installer - Welcome and introduction" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 3: Confirm and Install</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">Click the <strong>"Install"</strong> button to perform a standard installation on your primary drive (Macintosh HD). This copies the native <code>reaper_virtue.dylib</code> C++ extension directly to your REAPER UserPlugins path.</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_03.png" alt="macOS Installer - Click Install" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 4: Custom Clean Installation (Optional)</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">If you ever need to purge old configuration databases and backup custom thumbnails to your Desktop, click the <strong>"Customize"</strong> button on the installation type screen, then check the <strong>"Clean Installation (Backup & Purge)"</strong> option before installing.</p>
                      <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                          <img src="../Mac_Installer_Custom_02.png" alt="macOS Installer - Custom selection" style="width: 100%; display: block;" />
                        </figure>
                        <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                          <img src="../Mac_Installer_Custom_03.png" alt="macOS Installer - Purge and backup customization description" style="width: 100%; display: block;" />
                        </figure>
                      </div>
                    </div>

                    <div>
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 5: Finish Installation & Launch</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">Once files are copied, review the success screen and click <strong>"Close"</strong>. Open REAPER, go to the Actions List (press <kbd>?</kbd>), search for <em>"Virtue FX Manager"</em>, and run it to open the window. The native extension is now active!</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_04.png" alt="macOS Installer - Success screen" style="width: 100%; display: block;" />
                      </figure>
                    </div>
                  </div>
                </div>
                ...
                <div class="os-tab-content" data-os="windows">
                  ...
                  <p style="margin-bottom: 1.5rem; font-size: 0.95rem; line-height: 1.6;">
                    Because Virtue FX Manager is a newly released app, Windows Defender SmartScreen may initially show a warning popup when you run the downloaded <code>vfxm-win.exe</code> installer. Follow these simple steps to bypass the protection and complete the installation:
                  </p>

                  <div style="display: flex; flex-direction: column; gap: 2rem; margin-top: 1rem;">
                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 1: Open More Info</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">When the "Windows protected your PC" blue alert appears, click the <strong>"More info"</strong> link under the warning text.</p>
                      <figure style="margin: 0; max-width: 535px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_protection_more_info.png" alt="Windows protected your PC - Click More info" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 2: Run the Installer Anyway</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">The publisher will show as "Unknown publisher" because the app is new. Click the <strong>"Run anyway"</strong> button that appears at the bottom of the dialog.</p>
                      <figure style="margin: 0; max-width: 535px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_protection_run_anyway.png" alt="Windows protected your PC - Click Run anyway" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 3: Uninstall Previous Version (If Upgrading)</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">If you are updating from an older version of VFxM, the installer will ask to uninstall the previous version. Click <strong>"Yes"</strong> to perform a clean reinstall (your plugin ratings, notes, and favorites boards will remain safe).</p>
                      <figure style="margin: 0; max-width: 406px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_uninstall_previous.png" alt="Uninstall previous version prompt" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 4: Confirm Installation Settings</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">Once the setup wizard opens and shows "Ready to Install", click the <strong>"Install"</strong> button to copy the plugin files into your REAPER directory.</p>
                      <figure style="margin: 0; max-width: 596px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_ready.png" alt="Ready to Install screen" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div>
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">Step 5: Finish Installation</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">After files are copied, review the success information screen and click <strong>"Next"</strong> (then click <strong>"Finish"</strong>) to close the wizard. Open REAPER to start using Virtue FX Manager.</p>
                      <figure style="margin: 0; max-width: 596px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_info.png" alt="Installation completed screen" style="width: 100%; display: block;" />
                      </figure>
                    </div>
                  </div>
                </div>
              ...
              <!-- Common Launching & Activation section -->
              <div style="margin-top: 2rem; border-top: 1px solid var(--line); padding-top: 2rem;">
                <h4>Launching & License Activation Setup</h4>
                <ul>
                  ...
                  <li><strong>Activation & Deactivation Safeguards:</strong> Click the gear icon inside the app (Settings) to navigate to the License tab, enter your secure Polar License Key, and click "Activate Key". To protect your active installations, a confirmation deactivation dialog guards the license removal action.</li>
                  <li><strong>Trial Limits & Validation:</strong> New users can trigger a 10-day evaluation trial by clicking "Continue Trial" on the activation dialog. The evaluation trial runs fully featured without restrictions.</li>
                  <li><strong>macOS Focus Event Routing:</strong> VFxM implements active focus-override routing on macOS. This enables list scroll, grid click, and settings controls to capture first-click focus mouse interactions immediately even when the manager's panel is currently backgrounded.</li>
                </ul>

                <figure style="margin-top: 1.5rem; max-width: 531px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                  <img src="../VFxM_002_License.png" alt="Virtue FX Manager Trial Activation Prompt" style="width: 100%; display: block;" />
                  <figcaption class="media-caption" style="text-align: center; margin-top: 0.5rem; font-size: 0.82rem;">Trial version splash screen and activation dialog</figcaption>
                </figure>
              </div>
            </div>`
        },
    ...
    zh: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. 安装与启动 (App 使用指南)",
          content: `<div>
              <p>在开始整理您的插件之前，您必须在系统中安装并激活 Virtue FX Manager。请根据您的操作系统选择下方的安装指南：</p>
              ...
              <div class="os-tab-container">
                ...
                <div class="os-tab-content active" data-os="mac">
                  ...
                  <p style="margin-bottom: 1.5rem; font-size: 0.95rem; line-height: 1.6;">
                    Virtue FX Manager for macOS 以磁盘镜像 (<code>.dmg</code>) 封装的已签名且公证的安装包 (<code>.pkg</code>) 形式分发。请按照以下步骤完成安装：
                  </p>

                  <div style="display: flex; flex-direction: column; gap: 2rem; margin-top: 1rem;">
                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 1：打开 DMG 镜像</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">双击下载的 <code>VirtueFXManager.dmg</code> 磁盘镜像。在弹出的窗口中，您将看到安装包 <strong>"VirtueFXManager.pkg"</strong> 以及卸载工具 <strong>"Uninstall Virtue"</strong>。</p>
                      <figure style="margin: 0; max-width: 800px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_01.png" alt="macOS DMG - 打开 DMG 内容" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 2：运行安装包</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);"><strong>重要提示：在运行安装程序之前，请务必完全关闭 REAPER。</strong>然后双击 <code>VirtueFXManager.pkg</code> 图标以启动安装向导。在欢迎界面点击<strong>“继续”</strong>。</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_02.png" alt="macOS 安装向导 - 欢迎与介绍" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 3：确认并安装</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">点击<strong>“安装”</strong>按钮以在您的主硬盘（Macintosh HD）上执行标准安装。这将把原生的 <code>reaper_virtue.dylib</code> C++ 扩展程序直接复制到您的 REAPER UserPlugins 路径中。</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_03.png" alt="macOS 安装向导 - 点击安装" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 4：自定义全新安装（可选）</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">如果您需要清除旧的配置数据库并将自定义缩略图备份到桌面上，请在“安装类型”界面点击<strong>“自定”</strong>（Customize）按钮，然后在安装前勾选<strong>“全新安装 (备份并清除)”</strong>（Clean Installation (Backup & Purge)）选项。</p>
                      <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                          <img src="../Mac_Installer_Custom_02.png" alt="macOS 安装向导 - 自定义选择" style="width: 100%; display: block;" />
                        </figure>
                        <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                          <img src="../Mac_Installer_Custom_03.png" alt="macOS 安装向导 - 清除与备份定制说明" style="width: 100%; display: block;" />
                        </figure>
                      </div>
                    </div>

                    <div>
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 5：完成安装与启动</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">文件复制完成后，确认成功提示界面并点击<strong>“关闭”</strong>。打开 REAPER，进入动作列表（快捷键 <kbd>?</kbd>），搜索 <em>"Virtue FX Manager"</em>，然后运行该动作以打开窗口。此时原生扩展已成功启用！</p>
                      <figure style="margin: 0; max-width: 620px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../Mac_Installer_04.png" alt="macOS 安装向导 - 成功界面" style="width: 100%; display: block;" />
                      </figure>
                    </div>
                  </div>
                </div>
                ...
                <div class="os-tab-content" data-os="windows">
                  <h4>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><rect x="9" y="9" width="6" height="6"></rect><line x1="9" y1="1" x2="9" y2="4"></line><line x1="15" y1="1" x2="15" y2="4"></line><line x1="9" y1="20" x2="9" y2="23"></line><line x1="15" y1="20" x2="15" y2="23"></line><line x1="20" y1="9" x2="23" y2="9"></line><line x1="20" y1="15" x2="23" y2="15"></line><line x1="1" y1="9" x2="4" y2="9"></line><line x1="1" y1="15" x2="4" y2="15"></line></svg>
                    Windows SmartScreen 与安装指南
                  </h4>
                  <p style="margin-bottom: 1.5rem; font-size: 0.95rem; line-height: 1.6;">
                    由于 Virtue FX Manager 是新发布的软件，在运行下载的 <code>vfxm-win.exe</code> 安装程序时，Windows Defender SmartScreen 可能会弹出安全警告。请按照以下简单步骤绕过保护并完成安装：
                  </p>

                  <div style="display: flex; flex-direction: column; gap: 2rem; margin-top: 1rem;">
                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 1：打开“更多信息”</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">当弹出“Windows 已保护你的电脑”蓝色警报时，点击警告文本下方的<strong>“更多信息”</strong>链接。</p>
                      <figure style="margin: 0; max-width: 535px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_protection_more_info.png" alt="Windows 已保护你的电脑 - 点击更多信息" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 2：仍要运行</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">由于软件较新，发布者会显示为“未知发布者”。点击窗口底部出现的<strong>“仍要运行”</strong>按钮。</p>
                      <figure style="margin: 0; max-width: 535px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_protection_run_anyway.png" alt="Windows 已保护你的电脑 - 点击仍要运行" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 3：卸载旧版本（如果升级）</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">如果您是从旧版本的 VFxM 进行升级，安装程序会提示卸载以前的版本。点击<strong>“是”</strong>以执行全新重新安装（您的插件评分、备注和收藏夹分组均会安全保留）。</p>
                      <figure style="margin: 0; max-width: 406px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_uninstall_previous.png" alt="提示卸载以前的版本" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div style="border-bottom: 1px solid var(--line); padding-bottom: 1.5rem;">
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 4：确认安装设置</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">安装向导打开并显示“准备安装”后，点击<strong>“安装”</strong>按钮以将插件文件复制到您的 REAPER 目录中。</p>
                      <figure style="margin: 0; max-width: 596px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_ready.png" alt="准备安装界面" style="width: 100%; display: block;" />
                      </figure>
                    </div>

                    <div>
                      <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; color: var(--ink);">步骤 5：完成安装</h5>
                      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: var(--muted);">文件复制完成后，阅读完成信息界面并点击<strong>“下一步”</strong>（然后点击<strong>“完成”</strong>）关闭向导。打开 REAPER 即可开始使用 Virtue FX Manager。</p>
                      <figure style="margin: 0; max-width: 596px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                        <img src="../windows_install_info.png" alt="安装完成界面" style="width: 100%; display: block;" />
                      </figure>
                    </div>
                  </div>
                </div>
              ...
              <div style="margin-top: 2rem; border-top: 1px solid var(--line); padding-top: 2rem;">
                <h4>启动与许可激活设置</h4>
                <ul>
                  <li><strong>在 REAPER 中启动：</strong>打开 REAPER，进入动作列表（快捷键 <kbd>?</kbd>），搜索 <em>"Virtue FX Manager"</em>，运行该动作即可打开主窗口。</li>
                  <li><strong>激活与反激活保护：</strong>点击应用内的齿轮图标（设置），切换到“许可”选项卡，输入您的 Polar 许可密钥，然后点击“激活密钥”。为了防止误操作，反激活（注销授权）时会弹出二次确认窗口。</li>
                  <li><strong>试用限制与验证：</strong>新用户可以点击激活窗口上的“开始免费试用”以开启为期 10 天的评估试用。评估试用版拥有全部功能，没有任何限制。</li>
                  <li><strong>macOS 焦点事件路由：</strong>VFxM 在 macOS 上实现了主动焦点覆盖。这使得当管理面板处于后台非活动状态时，列表滚动、网格点击和设置项依然能直接响应您的第一次鼠标点击，无需先点击激活窗口。</li>
                </ul>

                <figure style="margin-top: 1.5rem; max-width: 531px; border: 1px solid var(--line); border-radius: 6px; overflow: hidden;">
                  <img src="../VFxM_002_License.png" alt="Virtue FX Manager 试用版激活提示" style="width: 100%; display: block;" />
                  <figcaption class="media-caption" style="text-align: center; margin-top: 0.5rem; font-size: 0.82rem;">试用版启动界面与激活对话框</figcaption>
                </figure>
              </div>
            </div>`
        },
        ...
        {
          id: "troubleshooting-mac-permissions",
          title: "8. 解决 macOS 权限问题",
          content: `<div>
              <p>Apple macOS 操作系统对屏幕录制/截图有非常严格的安全隐私政策。当 Virtue FX Manager 首次尝试截取插件缩略图时，macOS 很可能会阻止该操作并弹出权限申请提示。</p>
              
              <div style="padding: 1.2rem; border-radius: 8px; border: 1px solid var(--line); background-color: var(--surface); margin: 1rem 0">
                <h4 style="margin: 0 0 0.5rem 0; color: var(--accent)">如何开启屏幕录制权限</h4>
                <ol style="margin: 0; padding-left: 1.2rem">
                  <li style="margin-bottom: 0.5rem">打开您 Mac 的<strong>系统设置</strong>，然后导航至<strong>隐私与安全性</strong>。</li>
                  <li style="margin-bottom: 0.5rem">点击<strong>屏幕与系统音频录制</strong>（在较旧 Jun 版本的 macOS 中名为<em>屏幕录制</em>）。</li>
                  <li style="margin-bottom: 0.5rem">在列表中找到 <strong>REAPER.app</strong> 并将旁边的开关切换为<strong>开启</strong>。</li>
                  <li><strong>重要提示：</strong>您必须完全<strong>退出并重新启动 REAPER</strong>，权限设置才能正式生效。如果您不重启 REAPER，系统将继续阻止缩略图的截取。</li>
                </ol>
              </div>
              <p>在授予正确权限并重启 REAPER 后，您就可以直接使用缩略图截取快捷键（<code>C</code>）即时捕获插件画面，而不会再弹出任何权限提示。</p>
            </div>`
        },
        {
          id: "scanner-stability",
          title: "9. 自动缩略图扫描与稳定性",
          content: `<div>
              <p>自动缩略图扫描程序旨在为您节省数十小时的手动操作，帮您自动建立视觉插件库。它会在临时轨道上动态实例化插件、渲染其图形界面、捕获裁剪后的屏幕截图，然后将其卸载。</p>
              
              <h4 style="margin: 1rem 0 0.5rem 0; color: var(--accent)">灵活的扫描选项</h4>
              <ul>
                <li><strong>完整库扫描：</strong> 从设置菜单（齿轮图标）启动批量库重建。您可以选择扫描所有插件，或者只针对缺失缩略图的插件进行扫描。</li>
                <li><strong>针对性选择扫描：</strong> 在主浏览器或收藏夹列表中直接选择一个或多个插件，右键点击并选择<strong>“自动捕获所选缩略图”</strong>（Autocapture Selected Thumbnails），以便仅为高亮的条目构建图像。</li>
              </ul>

              <h4 style="margin: 1rem 0 0.5rem 0; color: var(--accent)">内置防崩溃恢复机制</h4>
              <p>虽然扫描器经过了高度优化，并包含了在清理期间保持插件安全加载的内存固定（memory-pinning）功能，但音频插件的生态极其庞大。因此，在短时间内快速连续加载某些不稳定的插件偶尔可能会导致 REAPER 发生崩溃。为此我们专门设计了具备完整容错恢复能力的扫描器，确保您的扫描进度绝不会丢失：</p>
              <ul>
                <li><strong>自动恢复扫描：</strong> 如果 REAPER 在扫描期间崩溃，只需重新启动它。扫描器会自动检测到中断，并提示您从上次停止的确切位置继续扫描。</li>
                <li><strong>智能黑名单系统：</strong> 重新启动后，系统会自动将导致崩溃的那个特定插件加入黑名单。这会绕过有问题的插件文件，以防止重复崩溃并保障您后续的使用。您可以随时在设置面板中管理并清除该黑名单。</li>
                <li><strong>实时进度覆盖层：</strong> 扫描时，屏幕上会显示一个进度条，展示当前队列索引、活动插件名称、预估剩余时间 (ETA) 以及一个随时可以安全中止扫描的<strong>“取消”</strong>按钮。</li>
              </ul>

              <div style="padding: 1rem; border-radius: 8px; border: 1px solid rgba(220, 62, 54, 0.2); background-color: rgba(220, 62, 54, 0.04); margin: 1rem 0">
                <h4 style="margin: 0 0 0.5rem 0; color: #dc3e36">最佳实践与免责声明</h4>
                <p style="margin: 0; font-size: 0.9rem">为了确保最平稳地部署，我们强烈建议遵循设置说明（例如隔离已知的崩溃路径或妥善管理断开的外部驱动器）。鉴于托管第三方软件所固有的不可预测性，使用自动扫描功能所产生的风险完全由用户自行承担。对于因第三方插件在扫描过程中不稳定而导致的数据丢失或系统中断，VFxM 不承担任何责任。</p>
              </div>
            </div>`
        }
      ]
    ...
    pt: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. Instalação & Inicialização (Guia de Usabilidade do App)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    es: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. Instalación y Lanzamiento (Guía de Usabilidad del App)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    de: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. Installation & Start (Bedienungsanleitung)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    hi: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. स्थापना और प्रारंभ (ऐप उपयोग गाइड)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    ar: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. التثبيت والتشغيل (دليل استخدام التطبيق)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    bn: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. ইনস্টলেশন এবং লঞ্চিং (অ্যাপ ব্যবহারকারী নির্দেশিকা)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
    ...
    ur: {
      ...
      sections: [
        {
          id: "installation-launching",
          title: "0. انسٹالیشن اور لانچنگ (ایپ کے استعمال کا گائیڈ)",
          content: `<div>
              <p>Before organizing your plugins, you must install and activate Virtue FX Manager on your system. Please choose the installation guide below matching your operating system:</p>
