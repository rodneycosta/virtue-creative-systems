    ...
    <section className="pricing-wrap" id="pricing" data-screen-label="07 Pricing">
      ...
      <div className="pricing-card">
        ...
        <div className="pricing-variant">
          <label className="pricing-variant-label" htmlFor="rz-variant">Choose Plan</label>
...
const FAQ = () => {
  const items = [
    ...
    },
    {
      ...
      a: 'Absolutely. VFxM is compiled natively for Apple Silicon (ARM64) and Intel (x86_64) platforms on macOS 11 (Big Sur) and newer, as well as 64-bit systems on Windows 10 & 11.'
    },
    {
