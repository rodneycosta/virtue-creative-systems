...
function renderHeader() {
  ...
  header.innerHTML = `
    ...
    <div class="site-header-actions">
      ...
      <a href="${sitePath("support/")}" class="header-btn header-btn-secondary">Recover Key</a>
      <a href="${sitePath("download/")}" class="header-btn header-btn-secondary">Download Trial</a>
      <a href="${sitePath("store/")}" class="header-btn header-btn-primary">Buy now !</a>
    </div>
  `;
}
  ...
  footer.innerHTML = `
    <div class="footer-grid">
      ...
      <div class="footer-links">
        ...
        <a href="${sitePath("download/")}">Download Trial</a>
        <a href="${sitePath("store/")}">Buy now !</a>
...
function setupCommerceLinks() {
  ...
  document.querySelectorAll("[data-checkout-link]").forEach((link) => {
    ...
    const variant = commerceVariant(variantKey);
    const liveLabel = link.dataset.liveLabel || "Buy now !";
